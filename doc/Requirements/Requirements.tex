...
%% REMOVE ALL REFERENCES TO DATABASE IN ALL FOLLOWING SECTIONS
...
%% THIS SECTION NEEDS TO BE MUCH MORE IN-DEPTH, AS IT IS THE MAIN FUNCTIONALITY
%  OF A POINT OF SALE SYSTEM.  ALSO REMOVE REFERENCE TO DATABASE.
...
%% DATABASE REFERENCE NEEDS TO BE REWORDED TO INFORMATION MANAGAMENT
    \subsection{Logging}
...
%% RECHECK THESE REPORTING ITEMS AND REFINE TO THOSE THAT ARE NECESSARY (FEASIBLE)
    \begin{itemize}
...
%% REMOVE INFO ABOUT wxWIN, AS THIS IS DESIGN STUFF
...
%% ALL OF THE ITEMS IN THIS SECTION ARE SYS CONSTRAINTS
