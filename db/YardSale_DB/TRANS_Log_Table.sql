...
CREATE TABLE Transaction_Log_Table(
	...
	TRANS_Comment				TEXT,
	TRANS_Time				DATETIME,
	TRANS_Always_NULL			INT,
	TRANS_REF_TRANS_Old_Trans		INT,
	...
	INDEX old_trans (TRANS_REF_TRANS_Old_Trans),
	INDEX emp_id (TRANS_REF_EMP_ID_Number),
	INDEX sku_num (TRANS_REF_INV_Item_ID),
	INDEX cust_acct (TRANS_REF_CUST_Account_Number),
	FOREIGN KEY (TRANS_REF_TRANS_Old_Trans) REFERENCES Transaction_Log_Table(Trans_ID),
